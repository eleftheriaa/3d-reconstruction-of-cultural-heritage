...
def parse_args():
    ...
    p.add_argument("--bg_threshold",  type=int, default=0,
                   help="Tolerance for background white detection (default: 0)")
    p.add_argument("--sat_threshold", type=int, default=5,
                   help="Tolerance for saturated pixel detection (default: 5)")
