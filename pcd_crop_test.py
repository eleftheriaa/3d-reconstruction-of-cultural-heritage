...
config_file = Path("outputs/cube-ngp-eval-interval-8-near35-far55-athre1e-3-grid-lvs-4/instant-ngp/2026-05-26_105014/config.yml")
config = yaml.load(config_file.read_text(), Loader=yaml.Loader)   
config.load_dir = Path("outputs/cube-ngp-eval-interval-8-near35-far55-athre1e-3-grid-lvs-4/instant-ngp/2026-05-26_105014/nerfstudio_models")
...
output_path = Path("pcd_box/point_cloud_crop_1M.ply")
